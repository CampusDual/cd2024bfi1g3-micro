...
void printInfo()
{
  ...
  Serial.print("RH = "); 
    Serial.print(mySHTC3.RH);                        // "toPercent" returns the percent humidity as a floating point number
    Serial.print("%, T = "); 
    Serial.print(-45 + 175 * ((float)mySHTC3.T / 65535));                           // "toDegF" and "toDegC" return the temperature as a flaoting point number in deg F and deg C respectively 
    Serial.println(" Cº"); 
